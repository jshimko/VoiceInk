...
final class KeychainService {
    ...
    private let logger = Logger(subsystem: AppConfig.shared.loggerSubsystem, category: "KeychainService")
    private let service = AppConfig.shared.mainBundleIdentifier
