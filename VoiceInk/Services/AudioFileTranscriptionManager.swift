...
class AudioTranscriptionManager: ObservableObject {
    ...
    private let logger = Logger(subsystem: AppConfig.shared.loggerSubsystem, category: "AudioTranscriptionManager")
    ...
    private func processItem(_ item: AudioFileQueueItem, modelContext: ModelContext, engine: VoiceInkEngine) async {
        ...
        do {
            ...
            let recordingsDirectory = AppConfig.shared.applicationSupportPath
