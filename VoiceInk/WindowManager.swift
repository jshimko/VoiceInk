...
class WindowManager: NSObject {
    ...
    private static let mainWindowIdentifier = NSUserInterfaceItemIdentifier("\(AppConfig.shared.mainBundleIdentifier).mainWindow")
    private static let onboardingWindowIdentifier = NSUserInterfaceItemIdentifier("\(AppConfig.shared.mainBundleIdentifier).onboardingWindow")
    private static let mainWindowAutosaveName = NSWindow.FrameAutosaveName("VoiceInkMainWindowFrame")

    private let logger = Logger(subsystem: AppConfig.shared.loggerSubsystem, category: "WindowManager")
