...
struct VoiceInkApp: App {
    ...
    init() {
        ...
        let appSupportDirectory = AppConfig.shared.applicationSupportPath
    ...
    private static func createPersistentContainer(schema: Schema, logger: Logger) throws -> ModelContainer {
        ...
        let dictionarySchema = Schema([VocabularyWord.self, WordReplacement.self])
            ...
            let dictionaryCloudKit: ModelConfiguration.CloudKitDatabase = .private(
                "iCloud.\(AppConfig.shared.mainBundleIdentifier)")
        #endif
                ...
                if hasCompletedOnboardingV2 {
                    ContentView()
                        ...
                        .onAppear {
                            ...
                            if AppConfig.shared.enableAnnouncements, enableAnnouncements {
                            ...
                            if let pendingURL = appDelegate.pendingOpenFileURL {
                                Logger(subsystem: AppConfig.shared.loggerSubsystem, category: "MenuBarWindowFlow").notice(
...
private struct MainWindowRequestBridge: View {
    private let logger = Logger(subsystem: AppConfig.shared.loggerSubsystem, category: "MenuBarWindowFlow")
...
class UpdaterViewModel: ObservableObject {
    ...
    init() {
        ...
        if config.enableAutoUpdates {
            ...
            automaticallyChecksForUpdates = autoUpdateCheck
